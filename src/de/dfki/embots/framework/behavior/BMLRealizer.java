...
//            log.info("Received input BML");
    ...
    private BMLBlock parseBML(String bmlText)
    {
        try {
            ...
            try {
                _bmlFeedbackSender.sendTextMessage(new BML1_0WarningFeedback(BML1_0Feedback.Type.WARNING, BML1_0WarningFeedback.Subtype.WARNING01, "", "", "Could not parse BML").toXML(), meta.getTime());
