...
public abstract class EMBOTSConstants
{
    ...
    //public final static String BML_FEEDBACK_TYPE = "DEFAULT_SCOPE";
    public final static String BML_FEEDBACK_TYPE = "semaine.data.bml.feedback";//"DEFAULT_SCOPE";
    ...
    public final static String BEHAVIOR_CALLBACK_TYPE = "semaine.callback.output.behavior";



//    public final static String EMBR_CHARACTER = "Amber";
    public final static String EMBR_CHARACTER = VirtualCharacter.AMBER.getName();
    //public final static String EMBR_CHARACTER = "Ben";
...
//    public static final String EMBRSCRIPT_LEXICON_DIR = "../data/embrscript/";
    ...
    public static final String BML_CRAB_LINE = "../data/bml/01Crab.bml";
}
