 ...
 * whenever a new message arrives, the SimpleJMSReceiver thread will call that listener's
 * {@link SEMAINEMessageAvailableListener#messageAvailableFrom(SimpleJMSReceiver)} method.
 * The listener code then calls the SimpleJMSReceiver's {@link #getMessage()} method from the
 * thread that should actually do the processing of the message. Note that in the
 * asynchronous API, the SimpleJMSReceiver will block until getMessage() was called.</li>
 * </ul>
 *
 * The SimpleJMSReceiver itself covers basic text messages only.
 ...
 *
 */
public class SimpleJMSReceiver extends Receiver
{
	 ...
	 */
	public SimpleJMSReceiver(String topicName) throws JMSException
	{
		super(topicName);
	 ...
	 */
	public SimpleJMSReceiver(String topicName, String messageSelector)
	throws JMSException
	{
		super(topicName);
	 ...
	 * @param topic the name of the JMS Topic to listen to.
	 */
	public SimpleJMSReceiver(String jmsUrl, String jmsUser, String jmsPassword, String topicName) throws JMSException
	{
	 ...
	 * for the detailed description.
	 */
	public SimpleJMSReceiver(String jmsUrl, String jmsUser, String jmsPassword, String topicName, String messageSelector)
	throws JMSException
	{
		super(jmsUrl, jmsUser, jmsPassword, topicName);
		consumer = session.createConsumer(topic, messageSelector);
	...
	throws MessageFormatException
	{
		...
		return new EMBOTSMessage(message);
	}
	...
	{
		SimpleJMSReceiver r = new SimpleJMSReceiver("testtopic");
		r.startConnection();
