...
//            Logger.getLogger(BehaviorBuilder.class.getName()).log(Level.SEVERE, null, ex);
        ...
        _currentBehavior = new PoseSequenceModel(this.getSelectedAgent());
...
//        System.out.println("++++++\n" + scriptString);
    ...
    {
        _currentBehavior.setAgentName(_agentSelect.getSelection().getActionCommand());
        if (!forSaving) {
...
//        _behaviorTable.updateTable();
    ...
    private String getSelectedAgent()
    {
        if (_agentSelect != null)
        {
            ...
            return VirtualCharacter.ALFONSE.getName();
    }
    ...
    public void createMenubar()
    {
        ...
        javax.swing.SwingUtilities.invokeLater(new Runnable()
        {
            ...
            public void run()
            {
                ...
                mi = new JRadioButtonMenuItem(VirtualCharacter.BEN.getName());
                mi.setActionCommand(VirtualCharacter.BEN.getName());
                agentMenu.add(mi);
                mi.addActionListener(agentSelectListener);
                _agentSelect.add(mi);
