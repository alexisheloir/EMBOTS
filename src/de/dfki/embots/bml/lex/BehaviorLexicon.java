...
public class BehaviorLexicon
{
    ...
    /**
     * Checks lexemes for correctness and only add those which pass the test.
     * To make access case-insensitive, all lexeme names are made uppercase.
     *
     * @param name Behavior name
     * @param beh Lexeme object
     * @param allowCorrupt if true corrupt lexemes will be added nevertheless
     */
    public void putLexeme(String name, BehaviorLexeme beh, boolean allowCorrupt)
    {
        if (checkLexeme(beh) || allowCorrupt) {
